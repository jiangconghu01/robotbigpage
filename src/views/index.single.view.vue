    ...
    <div class="container">
      ...
      <div class="img-path">
        <svg viewBox="0 0 2088 784" version="1.1">
          ...
          <circle cx="0" cy="0" r="8" stroke="none" fill="rgba(255, 255, 255, 0.677)">
            <animateMotion path="M1503.221,543.536718 L1384.98168,472.355418 L1363.85946,486.061936 L1205.68996,392 " dur="2s" fill="freeze" repeatCount="indefinite" begin="0.3s" />
          </circle>
        </svg>
      </div>
      <div class="text-layer">
        <div class="auto-export-1 normal">自动输出业务结果</div>
        <div class="auto-export-2 normal">自动输出异常报告</div>
        <div class="manual-exe normal">转人工处理</div>
        <div class="exc-status normal">异常</div>
        <div class="flage-box">
        ...
        <div class="acc-exc acc">
          <h3>累计异常单据</h3>
          <p><i class="num">66</i><i>笔</i></p>
        </div>
        <div class="normal-status normal">异常</div>
        <div class="right">
          <h3>10个流程</h3>
